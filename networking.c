...
// // MAKEFILE YAZILIP DENENECEK --- DENENDİ AMA ÇALIŞMADI BİR DAHA BAKILACAK
...
//         printf("Sunucudan veri bekleniyor...\n");
//         printf("%s ",recvline);     // diziyi sonlandırmak için maxline-1 yapılıyor
//         fflush(stdout); // burada n değeri okuma yaptığı sürece 0 dan büyüktür okuma bittiği zaman 0 a eşit olur ve döngüden çıkılır
//     }
//     printf("read() döngüsü çalışıyor. n = %d\n", n);
//     fflush(stdout);
//     if(n < 0){
